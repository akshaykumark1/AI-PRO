    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='flexapp.category')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flexapp.users')),
            ],
        ),
        migrations.CreateModel(
            name='reviews',
            fields=[
                ...
                ('description', models.TextField()),
                ('pname', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_reviews', to='flexapp.product')),
                ('uname', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='flexapp.users')),
            ],
        ),
        migrations.CreateModel(
            name='ViewHistory',
